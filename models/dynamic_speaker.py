...
class DynamicCore(nn.Module):
    def __init__(self, cfg):
        ...
        self.module_att_lstm = nn.LSTMCell(self.embed_dim + cfg.model.speaker.rnn_size+cfg.model.speaker.input_dim,
        ...
        self.lang_lstm = nn.LSTMCell(cfg.model.speaker.word_embed_size + \
                                     cfg.model.speaker.input_dim + cfg.model.speaker.input_dim,
                                     cfg.model.speaker.rnn_size)
    ...
    def forward(self, xt,
        ...
        module_att_lstm_input = torch.cat([embed, prev_h, feat_tag], 1)
        ...
        lang_lstm_input = torch.cat([xt, att_feat, feat_tag], 1)
...
class DynamicSpeaker(CaptionModel):
    ...
    def _sample(self,
                feat_bef, feat_aft,
                feat_diff, seq, feat_tag, cfg={}, sample_max=0):
