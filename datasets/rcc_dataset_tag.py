...
class RCCDataset(Dataset):
    ...
    def __init__(self, cfg, split):
        ...
        self.tag = self.h5_label_file['tags'][:]
        self.neg_tag = self.h5_label_file['neg_tags'][:]
    ...
    def __getitem__(self, index):
        ...
        tag_feature = torch.FloatTensor(self.tag[img_idx])
        neg_tag_feature = torch.FloatTensor(self.neg_tag[img_idx])
        ...
        return (d_feature, n_feature, q_feature,
                ...
                d_img_path, n_img_path, q_img_path, tag_feature, neg_tag_feature)
...
def rcc_collate(batch):
    ...
    tag_feature = default_collate(transposed[12])
    neg_tag_feature = default_collate(transposed[13])
    return (d_feat_batch, n_feat_batch, q_feat_batch,
            ...
            d_img_batch, n_img_batch, q_img_batch, tag_feature, neg_tag_feature)
